...
/**
 * Servlet implementation class ModifierServeurInfos
 */
@WebServlet("/ModifierServeurInfos")
public class ModifierServeurInfos extends HttpServlet {
