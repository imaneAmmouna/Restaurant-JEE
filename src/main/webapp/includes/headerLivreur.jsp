    ...
    * {
    ...
    <header>
        ...
        <ul class="navbar-list">
            <li class="navbar-item"><a href="ServletLivreurConsultation"><b>Consulter les Commandes</b></a></li>
            <li class="navbar-item"><a href="ModifierLivreurInfos"><b>Modifier le Mot de Passe</b></a></li>
